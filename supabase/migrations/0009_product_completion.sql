...
-- Give purpose-built system roles the least broad new permissions they need.
...
-- Track significant professional-profile changes for administration review.
...
-- Audit new administrative/operational tables.
do $$
declare t text;
begin
