...
const routes={
  individual:[["Overview",""],["Profile","profile"],["Portfolio","portfolio"],["Verification","verification"],["Appointments","appointments"],["Offers","offers"],["Projects","projects"],["Messages","messages"],["Payments","payments"],["Disputes","disputes"],["Reviews","reviews"],["AI CV Builder","cv-builder"],["Notifications","notifications"]],
  team:[["Overview",""],["Profile","profile"],["Portfolio","portfolio"],["Verification","verification"],["Appointments","appointments"],["Offers","offers"],["Projects","projects"],["Messages","messages"],["Payments","payments"],["Disputes","disputes"],["Reviews","reviews"],["Notifications","notifications"]],
  client:[["Overview",""],["Profile","profile"],["Find Talent","/talent"],["Saved Talent","favorites"],["Work Requests","work-requests"],["Projects","projects"],["Messages","messages"],["Payments","payments"],["Disputes","disputes"],["Reviews","reviews"],["Notifications","notifications"]]
} as const;
const arLabels:Record<string,string>={Overview:"نظرة عامة",Profile:"الملف الشخصي",Portfolio:"معرض الأعمال",Verification:"التحقق",Appointments:"المواعيد",Offers:"العروض",Projects:"المشاريع",Messages:"الرسائل",Payments:"المدفوعات",Disputes:"النزاعات",Reviews:"التقييمات","AI CV Builder":"منشئ السيرة الذاتية بالذكاء الاصطناعي",Notifications:"الإشعارات","Find Talent":"البحث عن المواهب","Saved Talent":"المواهب المحفوظة","Work Requests":"طلبات العمل"};
