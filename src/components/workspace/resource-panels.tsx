...
export function MessagesPanel(){
  ...
  useEffect(()=>{if(!room)return;void loadMessages(room);const t=setInterval(()=>void loadMessages(room),5000);return()=>clearInterval(t)},[room]);
