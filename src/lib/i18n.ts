...
const copy:Record<Locale,Copy>={
 ...
 tr:{
  ...
  hero:{eyebrow:"Doğrulanmış profesyonel pazar",title:"Gazze'den doğrulanmış yeteneklerle çalışın",body:"Net anlaşmalar, korumalı ödeme akışı ve kayıtlı teslim süreçleriyle profesyoneller ve ekiplerle çalışın.",primary:"Yetenekleri keşfet",secondary:"İş talebi yayınla"},
  stats:["Yüz yüze inceleme ile doğrulama","Özel ve hesap verebilir işbirliği","Ödeme güvenli proje akışı"],
 ...
 es:{
  ...
  hero:{eyebrow:"Mercado profesional verificado",title:"Contrata talento verificado de Gaza",body:"Trabaja con profesionales y equipos mediante acuerdos claros, pagos protegidos y entregas responsables.",primary:"Explorar talento",secondary:"Publicar un proyecto"},
